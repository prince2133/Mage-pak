...
const status = config.AUTO_READ_STATUS
...
const sessdata = config.SESSION_ID.split("DRK-MD=")[1];
...
console.log("Connecting DARK-MD Bot.....🔥");
...
console.log('DEVIL-TECH-MD Bot connected to whatsapp ✅')

let up = `*Connecting DEVIL-TECH-MD Multidevice Whatsapp Bot ...💾*
...
conn.sendMessage(conn.user.id,{ image: { url: `https://i.ibb.co/zhvB3bLg/7535.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94777899089")){
if(isReact) return
m.react("💀")
}
